...
//ComPort commoto	(UART0_SERCOM_NUM, PIO_UTXD0, PIO_URXD0, PIO_URXD0, UTXD0, URXD0, 0, PMUX_UTXD0, PMUX_URXD0, UART0_TXPO, UART0_RXPO, UART0_GEN_SRC, UART0_GEN_CLK, &UART0_DMA);
