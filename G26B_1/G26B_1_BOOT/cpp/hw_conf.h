...
#define INIT_PORTFIO_DIR 		PF4|PF6|PF7|PF9|PF10			
#define INIT_PORTGIO_DIR 		PG5|PG6|PG7|PG10|PG12|PG13|PG14|PG15
...
#define BOOT_SGUID					0x3FE0C8D103E14728 
#define BOOT_MGUID					0xA6FE828844CB84FF
...
#define MAIN_LOOP_PIN_SET()			{*pPORTGIO_SET = PG10;}
#define MAIN_LOOP_PIN_CLR()			{*pPORTGIO_CLEAR = PG10;}
#define MAIN_LOOP_PIN_TGL()			{*pPORTGIO_TOGGLE = PG10;}
